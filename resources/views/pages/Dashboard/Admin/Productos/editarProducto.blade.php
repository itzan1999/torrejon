...
@section('titulo','Editar Producto | Leche El Torrejon')
...
@push('js')
    <script type="module" src="{{ asset('resources/js/pages/Dashboard/Admin/Productos/editarProducto.js') }}"></script>
@endpush
...
<form id="formActualizarProducto" enctype="multipart/form-data">
    ...
    <button type="button" id="btnActualizarProducto" class="btn btn-dark">Actualizar Producto</button>
