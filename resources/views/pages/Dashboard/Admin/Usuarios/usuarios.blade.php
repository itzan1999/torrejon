...
@push('js')
    <script type="module" src="{{ asset('resources/js/pages/Dashboard/Admin/Usuarios/cargarUsuarios.js') }}"></script>
@endpush
...
<div class="d-flex justify-content-start mb-3 gap-2">
    <input type="text" id="buscador" class="form-control w-50" placeholder="Buscar por nombre, apellidos, username, email o rol…">
